...
export const AboutUs = () => {
  ...
  return (
    <section className='h-[calc(100dvh-5rem)] mdd:h-auto w-full' id="about_us">
      <div className='relative flex h-full w-full'>
        ...
        <div className='w-full absolute top-28 md:top-1/4 lg:top-1/4 xs:left-0 right-0 z-1 px-4' id='about_us_content'>
          <div className='max-w-6xl mx-auto flex flex-col smd:items-start items-end'>
            ...
            {
              sm && <div className="dark:bg-white/10 bg-gray bg-opacity-10 hover:!bg-primary rounded-md items-center flex justify-center p-3 hover:cursor-pointer mt-10 text-primary hover:text-white w-3/5">
