    ...
    return (
        <div className={`w-full`}>
            ...
            <input
                ...
                type={type ? type : 'text'}
                className={`${type == "file" ? fileInputClass : 'rounded-[4px] py-3 px-4'} w-full uppercase text-base font-black leading-none italic placeholder-darkest dark:placeholder-white bg-darkest/10 dark:bg-white/10 border-none outline-none resize-none focus:outline-primary focus:outline focus:outline-2 transition-all duration-300`}
                min={min ? min : 0}
                max={max}
